...
train_duration = 14 # Duration of the training set (15 day in total) 
...
plot_confusion_matrix( model, xtr[1], secuN_Y_train)
plot_confusion_matrix( model, xte[1], secuN_Y_test)
